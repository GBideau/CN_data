---
title: "#CN_elect\nLes communes nouvelles françaises : une analyse au prisme des élections"
author: "G. Bideau"
...
## Choix concernant les données utilisées en fonction des différentes élections
...
## Import des données des élections présidentielles et mise en forme

### Données des élections présidentielles à l'échelle communale
...
### Données élections présidentielles par commune
...
### Présidentielles à l'échelle des bureaux de vote
...
### Données élections présidentielles par bureau de vote (tous bureaux)
...
### Jonction des résultats des élections par bureaux de vote avec les géométries desdits bureaux
...
### Mise en forme des données des élections présidentielles par bureau de vote, spécifiquement pour les communes fusionnantes
...
### Compilation données pour obtenir les résultats à la géométrie 2011
...
```{r choix nombre k-means graphiques, eval=FALSE}
# Trop lourd à jouer
